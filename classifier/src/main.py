...
def main():
    base_path = "images/output/mssim_avg_0.95"
    paths = [
    ...
    run_experiment(paths, "experiments/experiment_results_mssim_avg_0_95.csv")

    config = FeatureConfig(color_channel=ChannelYUV.V, block_size=6, bin_width=0.1, dct_coefficients=[
        (0,5),(1,1),(1,3),(1,5),(4,5),(5,0)
    ])
    run_specific_experiment(paths, "experiments/experiment_results_mssim_avg_0_95_single.csv", config)
