...
def main():
    base_path = "images/output/niqe_3.5"
    paths = [
    ...
    run_experiment(paths, "experiments/experiment_results_niqe_3_5.csv")

    config = FeatureConfig(color_channel=ChannelYUV.V, block_size=6, bin_width=0.1, dct_coefficients=[
        (0,5),(1,1),(1,3),(1,5),(4,5),(5,0)
    ])
    run_specific_experiment(paths, "experiments/experiment_results_niqe_3_5_single.csv", config)
